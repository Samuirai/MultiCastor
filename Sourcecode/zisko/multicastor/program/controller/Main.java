...
public class Main {
	 ...
	 * Parameter ein, die dem Programm �begeben wurden und startet den entsprechenden Programmteil.
	 * @param args Ein Feld aus Strings, das die Parameter enth�lt, die dem Programm in der Kommandozeile �bergeben wurden.
	 */
	
	public static void main(String[] args) {
		//V1.5 [FH] Prüfen nach maximaler Heap-Size und ggf. Fehler ausgeben
